...
$cv->Write($cv->hLh, 'CV: ');
$cv->setLinkStyles();
$cv->Write($cv->hLh, 'Shawn Inder', 'mailto:shawninder@gmail.com');
$cv->Ln();

$cv->setNoteStyles();
$cv->Write($cv->nLh, '#: 514-903-9082'); 
$cv->Write($cv->nLh, 'For more details, visit ');
$cv->setLinkStyles();
$cv->Write($cv->nLh, 'my interactive CV', 'http://shawninder.99k.org');
$cv->setNoteStyles();
$cv->Write($cv->nLh, ' online!');
$cv->Ln(10);
